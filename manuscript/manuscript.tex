...
\input{parts/03_methods.tex}
\input{parts/04_results.tex}
\input{parts/05_discussion.tex}
\input{parts/06_limitations.tex}
\input{parts/07_conclusion_and_backmatter.tex}
